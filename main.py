...
def main():
    print(f"--- Starting Robust MCR Workflow ---")
    ...
    # 2. Initialize
    print("[2/4] Generating Initial Guess...")
    C_init = data_loader.generate_ratio_initialization(df, layer_cols, D_df.index)
    
    # 3. Solve
    print("[3/4] Running MCR-ALS Solver...")
    C_final, ST_final = solver.run_mcr_solver(D, C_init, coords)
